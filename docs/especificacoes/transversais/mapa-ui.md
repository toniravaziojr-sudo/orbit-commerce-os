...
| 30 | Marketplaces | Mercado Livre | `/marketplaces/mercadolivre` | marketplaces | `mercadolivre` | — | Badge "Upgrade" se bloqueado. Aba Anúncios usa assistente em lote com etapas Produtos, Categorias, Títulos, Descrições, Características, Condição, Tipo, Preços e Frete; Preços ajusta apenas o valor específico do anúncio no ML, sem alterar o cadastro do produto. |
