...
- [ ] Gestor de Tráfego IA — Sprint 14 (Motor Guardião edge function): Edge function `ads-autopilot-guardian` com ciclos diários automatizados
- [ ] Gestor de Tráfego IA — Sprint 15 (Motor Estrategista edge function): Edge function `ads-autopilot-strategist` com pipeline em 5 fases
