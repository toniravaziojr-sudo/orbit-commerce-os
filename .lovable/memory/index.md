...
- [Sales Pipeline v2.9 Working Memory Shadow Mode](mem://features/ai/sales-pipeline-v2-9-working-memory-shadow-mode) — Reg #2.9 Onda 2: tabela conversation_sales_state (7 estágios) é a memória persistente unificada da conversa de vendas. Módulos working-memory.ts e stage-machine.ts plugados em ai-support-chat em SHADOW MODE: logam e persistem, NÃO alteram resposta. Onda 3 ativará prompts por estágio.
