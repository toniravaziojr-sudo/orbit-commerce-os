...
- Bloquear ação por conflito **editorial** com diretriz de plataforma, função declarada do produto, claims, promessa cadastrada, descrição ou tipo do produto. Esses casos viram **aviso**, nunca bloqueio.
