...
import { downloadAndStoreCorreiosLabel, createLabelSignedUrl } from "../_shared/correios-label.ts";
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    return errorResponse(error, corsHeaders, { module: 'shipping', action: 'get-label' });
  }
});
