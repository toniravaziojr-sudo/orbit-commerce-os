    ...
    shippingHtml = `
      <div style="margin-top:16px;padding:16px;background:#f9f9f9;border-radius:8px;" data-sf-shipping-box data-product-id="${product.id}" data-product-price="${product.price}" data-product-weight="${(product as any).weight || 0.3}">
        ...
        <div style="display:flex;gap:8px;">
          <input type="text" placeholder="Digite seu CEP" maxlength="8" inputmode="numeric" autocomplete="new-password" autocorrect="off" autocapitalize="off" spellcheck="false" style="flex:1;padding:10px 12px;border:1px solid #ddd;border-radius:6px;font-size:14px;outline:none;font-family:var(--sf-body-font);" data-sf-shipping-cep>
