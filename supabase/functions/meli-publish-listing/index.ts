...
// humanizeMeliError + prettyAttrName: movidos para _shared/marketplace-adapter/meli/error-humanizer.ts (Onda C).
// Importados no topo do arquivo. Comportamento preservado.
