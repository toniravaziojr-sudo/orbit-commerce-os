...
const blockDefinitions: BlockDefinition[] = [
  ...
  },
  {
    ...
    propsSchema: {
      ...
      columns: { type: 'select', label: 'Colunas', options: [{ label: '2', value: '2' }, { label: '3', value: '3' }, { label: '4', value: '4' }], showWhen: { field: 'layout', value: 'grid' } },
      borderRadius: { type: 'number', label: 'Arredondamento (px)', showWhen: { field: 'layout', value: 'grid' } },
      slidesPerView: {
        type: 'select',
        label: 'Itens por Slide',
      ...
      autoplay: { type: 'boolean', label: 'Autoplay', showWhen: { field: 'layout', value: 'carousel' } },
      autoplayInterval: { type: 'number', label: 'Intervalo de Autoplay (s)', defaultValue: 5, min: 1, max: 30, showWhen: { field: 'layout', value: 'carousel' } },
      showArrows: { type: 'boolean', label: 'Mostrar Setas', showWhen: { field: 'layout', value: 'carousel' } },
      showDots: { type: 'boolean', label: 'Mostrar Indicadores', showWhen: { field: 'layout', value: 'carousel' } },
  ...
  // ========== FORMS BLOCKS (Formulários) ==========
  {
    ...
    propsSchema: {
      ...
      title: { type: 'string', label: 'Título', defaultValue: 'Receba nossas novidades', aiFillable: { hint: 'Título convidativo para newsletter', format: 'text' } },
      subtitle: { type: 'string', label: 'Subtítulo', defaultValue: 'Cadastre-se para receber ofertas exclusivas', aiFillable: { hint: 'Subtítulo com benefício de se cadastrar', format: 'text' } },
      ...
      buttonText: { type: 'string', label: 'Texto do Botão', defaultValue: 'Cadastrar', aiFillable: { hint: 'Call-to-action de cadastro, 1-3 palavras', format: 'cta' } },
      successMessage: { type: 'string', label: 'Mensagem de Sucesso', defaultValue: 'Cadastro realizado com sucesso!', aiFillable: { hint: 'Mensagem de confirmação após cadastro', format: 'feedback' } },
      layout: {
        type: 'select',
        label: 'Layout',
