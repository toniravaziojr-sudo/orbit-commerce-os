...
const blockDefinitions: BlockDefinition[] = [
  ...
  // ========== ESSENTIAL ECOMMERCE BLOCKS (non-removable) ==========
  {
    ...
    propsSchema: {
      title: { type: 'string', label: 'Título', defaultValue: 'Carrinho de Compras' },
      showCrossSell: { type: 'boolean', label: 'Mostrar Cross-sell', defaultValue: true },
      showCouponField: { type: 'boolean', label: 'Mostrar Campo de Cupom', defaultValue: true },
      showTrustBadges: { type: 'boolean', label: 'Mostrar Selos de Confiança', defaultValue: true },
      checkoutButtonText: { type: 'string', label: 'Texto do Botão Finalizar', defaultValue: 'Finalizar Compra' },
      continueShoppingText: { type: 'string', label: 'Texto Continuar Comprando', defaultValue: 'Continuar Comprando' },
      couponPlaceholder: { type: 'string', label: 'Placeholder do Cupom', defaultValue: 'Cupom de desconto' },
      couponButtonText: { type: 'string', label: 'Texto do Botão Cupom', defaultValue: 'Aplicar' },
      freeShippingThreshold: { type: 'number', label: 'Valor para Frete Grátis (R$)', defaultValue: 199, min: 0 },
      freeShippingLabel: { type: 'string', label: 'Label Frete Grátis', defaultValue: 'Frete Grátis' },
      trustBadge1Label: { type: 'string', label: 'Selo 1', defaultValue: 'Frete Grátis' },
      trustBadge2Label: { type: 'string', label: 'Selo 2', defaultValue: 'Compra Segura' },
      trustBadge3Label: { type: 'string', label: 'Selo 3', defaultValue: '12x s/ juros' },
    },
    canHaveChildren: false,
    isRemovable: false,
  },
  {
    ...
    propsSchema: {
      showOrderBump: { type: 'boolean', label: 'Mostrar Order Bump', defaultValue: true },
      showTimeline: { type: 'boolean', label: 'Mostrar Timeline', defaultValue: true },
      showPaymentOptions: { type: 'boolean', label: 'Mostrar Opções de Pagamento', defaultValue: true },
      showTrustBadges: { type: 'boolean', label: 'Mostrar Selos de Confiança', defaultValue: true },
      contactTitle: { type: 'string', label: 'Título - Contato', defaultValue: 'Informações de Contato' },
      shippingTitle: { type: 'string', label: 'Título - Entrega', defaultValue: 'Endereço de Entrega' },
      paymentTitle: { type: 'string', label: 'Título - Pagamento', defaultValue: 'Forma de Pagamento' },
      orderSummaryTitle: { type: 'string', label: 'Título - Resumo', defaultValue: 'Resumo do Pedido' },
      checkoutButtonText: { type: 'string', label: 'Texto do Botão', defaultValue: 'Finalizar Compra' },
      stepContactLabel: { type: 'string', label: 'Etapa - Contato', defaultValue: 'Contato' },
      stepShippingLabel: { type: 'string', label: 'Etapa - Entrega', defaultValue: 'Entrega' },
      stepPaymentLabel: { type: 'string', label: 'Etapa - Pagamento', defaultValue: 'Pagamento' },
      creditCardLabel: { type: 'string', label: 'Label - Cartão', defaultValue: 'Cartão de Crédito' },
      pixLabel: { type: 'string', label: 'Label - PIX', defaultValue: 'PIX' },
      boletoLabel: { type: 'string', label: 'Label - Boleto', defaultValue: 'Boleto Bancário' },
      pixDiscount: { type: 'string', label: 'Desconto PIX', defaultValue: '5% OFF' },
    },
    canHaveChildren: false,
    isRemovable: false,
  },
