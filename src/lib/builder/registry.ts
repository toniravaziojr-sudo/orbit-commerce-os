...
const blockDefinitions: BlockDefinition[] = [
  ...
  // LEGACY: FeaturedCategories and CategoryList removed — unified into CategoryShowcase
  // Aliases in BlockRenderer ensure existing layouts still render correctly
  {
