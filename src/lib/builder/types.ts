...
export interface BlockPropsSchema {
  [key: string]: {
    type: 'string' | 'number' | 'boolean' | 'select' | 'color' | 'image' | 'video' | 'richtext' | 'array' | 'product' | 'category' | 'menu' | 'categoryList' | 'textarea' | 'productMultiSelect' | 'categoryMultiSelect' | 'datetime';
    label: string;
