  ...
  return (
    <section className="relative overflow-hidden px-[5%] py-16 md:py-24" style={{ background: 'var(--lp-bg)' }}>
      ...
      <div className="relative max-w-[1100px] mx-auto">
        ...
        {validImages.length > 3 && (
          <>
            <button
              ...
              style={{ background: 'var(--lp-card-bg)', border: '1px solid var(--lp-card-border)', color: 'var(--lp-text)', boxShadow: '0 4px 16px var(--lp-shadow)' }}
            >
        ...
        >
          <style>{`
            .lp-sp-track::-webkit-scrollbar { display: none; }
          `}</style>
          {validImages.map((url, i) => (
            <div 
              ...
              style={{ 
                width: validImages.length <= 3 ? `${Math.floor(100 / validImages.length) - 2}%` : '280px',
                border: '1px solid var(--lp-card-border)',
