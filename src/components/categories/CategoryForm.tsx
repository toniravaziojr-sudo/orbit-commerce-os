...
export function CategoryForm({
  ...
  // Form fields content - used by both standalone and embedded modes
  const formContent = (
    <>
  ...
  // When hideActions is true, the parent manages the card wrapper and header
  // Return just the form fields without wrapper
  if (hideActions) {
    return <div className="space-y-4">{formContent}</div>;
  }

  // Standalone mode with full Card wrapper and action buttons
  return (
    <Card>
