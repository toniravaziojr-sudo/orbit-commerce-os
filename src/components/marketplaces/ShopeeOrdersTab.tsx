...
import { useShopeeOrders } from "@/hooks/useShopeeOrders";
...
export function ShopeeOrdersTab() {
  ...
  const { orders, total, isLoading, sync, isSyncing, refetch } = useShopeeOrders({
    status,
    page,
    pageSize: 20,
  });
      ...
      <CardContent className="space-y-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p>Nenhum pedido da Shopee encontrado.</p>
              ...
              <TableBody>
                {orders.map((order) => (
                  <TableRow key={order.id}>
                    ...
                    <TableCell>
                      {order.customer?.name || order.marketplace_data?.shopee_buyer_username || "-"}
                    </TableCell>
                    <TableCell>
