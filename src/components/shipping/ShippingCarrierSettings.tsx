...
const CARRIER_DEFINITIONS: CarrierDefinition[] = [
  ...
  },
  {
    ...
    name: 'Loggi',
    logo: '🛵',
    description: 'Entregas urbanas rápidas e eficientes. Configure as credenciais fornecidas pela Loggi.',
    fields: [
      { key: 'client_id', label: 'Client ID', type: 'text', placeholder: 'smb-...-service-account' },
      { key: 'client_secret', label: 'Client Secret', type: 'password', placeholder: 'Segredo do integrador' },
      { key: 'company_id', label: 'Company ID (Embarcador)', type: 'text', placeholder: '1491431' },
      { key: 'external_service_id', label: 'External Service ID', type: 'text', placeholder: 'DLVR-SPOT-DOOR-STAN-01' },
