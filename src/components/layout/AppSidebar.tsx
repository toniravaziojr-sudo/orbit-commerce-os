...
const fullNavigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Logística Interna", href: "/shipping", icon: Truck, blockedFeature: "remessas" },
      { title: "Logística Externa", href: "/external-shipping", icon: Truck, blockedFeature: "remessas" },
    ],
  },
  {
    label: "Parcerias",
...
export function AppSidebar() {
  ...
  return (
    <aside
      className={cn(
        "relative flex h-dvh min-h-0 flex-col border-r border-sidebar-border bg-sidebar transition-all duration-300",
