  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <PageHeader
        ...
        description="Monitore jobs, tarefas agendadas e alertas operacionais do sistema"
        actions={
      ...
      <Tabs defaultValue="executions" className="space-y-6">
        ...
        <TabsContent value="executions" className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <StatCard title="Em Execução" value="0" icon={Activity} variant="primary" />
            <StatCard title="Na Fila" value="0" icon={Clock} variant="warning" />
            <StatCard title="Concluídos (24h)" value="0" icon={CheckCircle} variant="success" />
            <StatCard title="Falhas (24h)" value="0" icon={XCircle} variant="destructive" />
          </div>
            ...
            <CardContent className="pt-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <div className="relative flex-1">
                  ...
                  <Input placeholder="Buscar por ID, tipo ou descrição..." className="pl-9" />
                </div>
